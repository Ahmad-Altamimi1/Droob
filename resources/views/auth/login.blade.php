 ...
 <section class="sign-in">
            ...
            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="your_name" placeholder="الأيميل"/>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="social-login">
                            <span class="social-label">تسجيل الدخول من خلال حسابات التواصل الأجتماعي</span>
                            <ul class="socials">
                     ...
                     <div class="signin-image">
                        ...
                        <a href="{{ route('register') }}" class="signup-image-link">أنشاء حساب ؟</a>
                    </div>
                </div>
            </div>
        </section>
